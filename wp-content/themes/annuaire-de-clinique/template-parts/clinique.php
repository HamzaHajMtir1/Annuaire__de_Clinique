<?php
/**
 * Template part for displaying cliniques
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		$clinique_id= get_the_ID();
		$adresse = get_post_meta($clinique_id,'Adresse',true);
		$tel = get_post_meta($clinique_id,'Tel',true);
		$fax = get_post_meta($clinique_id,'Fax',true);
		$site_internet = get_post_meta($clinique_id,'Site_internet',true);
